...
data_path_cell="/warm/ldiaz/lingqi_bk/Projects/Ben_Project/WES_mouse_01062020/Project_10212_B"
project=PROJECT
subject=SUBJECT
# cell line data as control
sample_ctl="PARENTAL_SAMPLE"

# tissue data as treatment
sample_treatment="TREATED_SAMPLE"

vcf_ctl=${data_path}/Cellline_Data/${sample_ctl}.aligned.duplicates_marked.recalibrated.filtered.w.BALCnormal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf
