...
sample_treatment="Sample_CT26_DMBA_8W_IGO_10212_3"
...
/home/luol2/lingqi_workspace/gatk-4.0.1.2/gatk --java-options "-Xmx${command_mem}m" \
SelectVariants \
-R ${ref_fasta} \
-V ${vcf_treatment} \
--discordance ${vcf_ctl} \
-O ${data_path}/data_analysis/${sample_ctl}_vs_${sample_treatment}.snp_indel.Somatic.hc.fpfilter.vcf
