...
data_path=DATA_PATH
project=PROJECT
subject=SUBJECT # for treatment
subject_c=SUBJECC # for control
sample_ctl="PARENTAL_SAMPLE"
sample_treatment="TREATED_SAMPLE"

vcf_ctl=${data_path}/${project}/${subject_c}/${sample_ctl}/${sample_ctl}.aligned.duplicates_marked.recalibrated.filtered.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf
vcf_treatment=${data_path}/${project}/${subject}/${sample_treatment}/${sample_treatment}.aligned.duplicates_marked.recalibrated.filtered.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf
...
command_mem="100"
/home/luol2/lingqi_workspace/gatk-4.0.1.2/gatk  --java-options "-Xmx${command_mem}m" SelectVariants \
    -R ${ref_fasta} \
    -V ${vcf_treatment} \
    --discordance ${vcf_ctl} \
    -O ${data_path}/${project}/${subject}/${sample_ctl}_vs_${sample_treatment}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf

# rename the sample name to Gain.{tumor.samplename}
sed -i "s/${sample_treatment}$/Gain.${sample_treatment}/g" \
${data_path}/${project}/${subject}/${sample_ctl}_vs_${sample_treatment}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf

module load singularity/3.1.1
VEPInputVcf=${sample_ctl}_vs_${sample_treatment}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf
VEPOutputVcf=${sample_ctl}_vs_${sample_treatment}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.VEP.ann.vcf
VEPOutputStat=${sample_ctl}_vs_${sample_treatment}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.VEP.ann.summary.html
...
# grab difference as treatment variant gain from Parental
command_mem="100"
/home/luol2/lingqi_workspace/gatk-4.0.1.2/gatk  --java-options "-Xmx${command_mem}m" SelectVariants -R ${ref_fasta} -V ${vcf_ctl} --discordance ${vcf_treatment} -O ${data_path}/${project}/${subject}/${sample_treatment}_vs_${sample_ctl}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf

# rename the sample name to Loss.{tumor.samplename}
sed -i "s/${sample_ctl}$/Loss.${sample_treatment}/g" \
${data_path}/${project}/${subject}/${sample_treatment}_vs_${sample_ctl}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf

module load singularity/3.1.1
VEPInputVcf=${sample_treatment}_vs_${sample_ctl}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.vcf
VEPOutputVcf=${sample_treatment}_vs_${sample_ctl}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.VEP.ann.vcf
VEPOutputStat=${sample_treatment}_vs_${sample_ctl}.w.C57BL_6NJ.normal.rm_MGP_snps_indels.singleSample.PASSOnly.VEP.ann.summary.html
#Perform VEP using local cache (Mouse)
singularity run --bind ${data_path}/${project}/${subject}:/data --bind /home/luol2/lingqi_workspace/vep_data:/vep_data \
/home/luol2/lingqi_workspace/ensembl-vep.sif \
vep -i /data/${VEPInputVcf} \
