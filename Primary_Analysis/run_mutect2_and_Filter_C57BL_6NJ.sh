...
normal_bam=${data_path}/${project}/PITT_0525/${normal_sample}/${normal_sample}.aligned.duplicates_marked.recalibrated.bam
tumor_name=${data_path}/${project}/${subject}/${sample}/tumor_name.txt
normal_name=${data_path}/${project}/PITT_0525/${normal_sample}/normal_name.txt
