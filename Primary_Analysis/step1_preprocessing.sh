...
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g;s#READGROUP#$ENV{readGroup}#g' run_fastq_to_uBAM.sh | bsub -J uBAM_${project}_${subject}_${sample}
...
#5. BWA MEM Alignment
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g' run_bwa_mem.sh | bsub -J bwa_${project}_${subject}_${sample}
...
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g' run_qualimap.sh | bsub -J qualimap_${project}_${subject}_${sample}
...
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g' run_CollectHsMetrics.sh | bsub -J Hs_${project}_${subject}_${sample}
...
#6.3 MultipleMetrics
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g' run_CollectQualityMetrics.sh | bsub -J Quality_${project}_${subject}_${sample}
...
#7. MarkDuplicate
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g' run_markduplicate.sh | bsub -J markdup_${project}_${subject}_${sample}
...
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g' run_BaseRecalibrator.sh | bsub -J BQSR_${project}_${subject}_${sample}
...
#9. Apply BQSR
perl -pe 's#TEST_SAMPLE#$ENV{sample}#g;s#PROJECT#$ENV{project}#g;s#SUBJECT#$ENV{subject}#g;s#DATA_PATH#$ENV{data_path}#g' run_ApplyBQSR.sh | bsub -J ApplyBQSR_${project}_${subject}_${sample}
